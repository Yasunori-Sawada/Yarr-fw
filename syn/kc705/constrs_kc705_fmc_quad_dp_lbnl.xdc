#la32_n
#la32_p
set_property PACKAGE_PIN AA30 [get_ports {scl_o}]
set_property PACKAGE_PIN Y30 [get_ports {latch_o}]
#la30_n
#la30_p
...
#la00_cc_n
#la00_cc_p
set_property PACKAGE_PIN AD23 [get_ports {fe_data_p[1]}]
set_property PACKAGE_PIN AE24 [get_ports {fe_data_n[1]}]
#la01_cc_n
#la01_cc_p
set_property PACKAGE_PIN AE23 [get_ports {fe_cmd_p[0]}]
set_property PACKAGE_PIN AF23 [get_ports {fe_cmd_n[0]}]
#la02_n
#la02_p
set_property PACKAGE_PIN AF20 [get_ports {fe_data_p[0]}]
set_property PACKAGE_PIN AF21 [get_ports {fe_data_n[0]}]
#la03_n
#la03_p
set_property PACKAGE_PIN AG20 [get_ports {fe_data_p[2]}]
set_property PACKAGE_PIN AH20 [get_ports {fe_data_n[2]}]
...
set_property PACKAGE_PIN AK20 [get_ports {fe_clk_p[0]}]
set_property PACKAGE_PIN AK21 [get_ports {fe_clk_n[0]}]
#la05_n
#la05_p
...
#la33_n
#la33_p
#Are they used for CMD?
#set_property PACKAGE_PIN AC30 [get_ports {sdi_i}]
#set_property PACKAGE_PIN AC29 [get_ports {sda_o}]
